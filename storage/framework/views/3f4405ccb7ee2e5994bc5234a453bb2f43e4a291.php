	...
	<div class="col-sm-12">
		...
		<form method="POST" action="/register">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="email" name="email" readonly value="<?php echo e(session('email')); ?>">
			</div>

			<div class="form-group">
				<label for="code">Promo Code:</label>
				<input type="text" class="form-control" id="code" name="code" readonly value="<?php echo e(session('code')); ?>">
			</div>
